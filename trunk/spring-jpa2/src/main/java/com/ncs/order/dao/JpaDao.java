...
public interface JpaDao<T extends Object> {
	...
	/**
	 * Gets a list of {@link Class} for each {@link java.persistence.Entity} type which this DAO can
	 * manage. This is used to enable DAO classes which manage multiple
	 * {@link java.persistence.Entity} of different types.
	 *
	 * @return
	 */
