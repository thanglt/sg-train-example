...
@Filter(name="active")
@Table(name = "SPMS_EXPORT_RESTRAINTS")
public class ExportRestraints extends BaseEntity{
	 ...
	 * 是否出口限制
	 */
	private boolean isExportRestraints;
	/*
	 * 附件说明
	 */
	...
	@Column( name = "IS_EXPORT_RESTRAINTS")
	public boolean isExportRestraints() {
		return isExportRestraints;
	}
	public void setExportRestraints(boolean isExportRestraints) {
		this.isExportRestraints = isExportRestraints;
	}
