package com.skynet.spms.persistence.entity.organization.enterpriseInformation.manufacturers;
 ...
 * @author 曹宏炜
 * @version 1.0
 * @created 24-三月-2011 16:03:17
 */
@Entity
@DiscriminatorValue("Manufacturer")
public class Manufacturer extends BaseEnterpriseInformation {
