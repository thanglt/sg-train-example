package com.skynet.spms.client.gui.supplierSupport.procurementOrder.stockSecurityOrder.add;
 ...
 *
 */
public class StockSecurityOrderAddWindow extends BaseWindow {

	/**
	 * 无需传递数据源 重载
	 * @param opm 当前操作方式
	 */
	public StockSecurityOrderAddWindow(String windowTitle, boolean isMax,
