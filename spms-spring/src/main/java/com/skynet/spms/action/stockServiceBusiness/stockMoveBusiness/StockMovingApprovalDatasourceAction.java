 ...
 */
@Component
public class StockMovingApprovalDatasourceAction implements DataSourceAction<StockMovingRecord>{
	@Autowired
	private StockMovingRecordManager stockMovingRecordManager;

	@Override
	public String[] getBindDsName() {
		return new String[]{"stockMovingApproval_dataSource"};
	}
	...
	public List<StockMovingRecord> getList(int startRow, int endRow) {
		return stockMovingRecordManager.GetAllbyApproval();
	}
}