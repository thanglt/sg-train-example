...
public class UserModifyWindow extends BaseWindow {

	public UserModifyWindow(String windowTitle, boolean isMax, Rectangle srcRect,
	...
	protected Canvas getLeftLayout(final Rectangle srcRect, ListGrid listGrid) {
		...
		addCloseClickHandler(new CloseClickHandler() {
			public void onCloseClick(CloseClientEvent event) {
				ShowWindowTools.showCloseWindow(srcRect, UserModifyWindow.this, -1);
			}
		});
