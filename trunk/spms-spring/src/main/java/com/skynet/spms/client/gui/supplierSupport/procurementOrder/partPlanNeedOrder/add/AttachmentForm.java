...
public class AttachmentForm extends VLayout {
	...
	private final ListGrid attachmentGrid = new ListGrid();
	...
	public AttachmentForm() {
		...
		SectionStackSection section = new SectionStackSection("备件计划需求附件");
		...
		ListGridField itemNumberField = new ListGridField("itemNumber", "项号");
	...
	private void refresh() {
		...
		conditions.addCriteria("uuid", model.partPlanNeedOrderId);
