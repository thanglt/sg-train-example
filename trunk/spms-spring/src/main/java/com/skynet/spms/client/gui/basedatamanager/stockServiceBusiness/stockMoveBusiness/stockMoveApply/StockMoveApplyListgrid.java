 ...
 *
 */
public class StockMoveApplyListgrid extends ListGrid{
	...
	public void drawStockMoveManageListgrid(){
		...
		setFields(numberFiled,movingOutStockRoomField,movingInStockRoomField,totalItemsField,totalAmountField,
				stateField,stockMovingReasonField,ratifierField,ratifyDateField);
