...
public class PickingTaskPanel extends ShowcasePanel {

	private static final String DESCRIPTION = "拣货任务跟踪信息维护页面";

	public static class Factory implements PanelFactory {

		private String DESCRIPTION = "拣货任务跟踪模块";
		private String id;
		
		public Canvas create() {
			PickingTaskPanel panel = new PickingTaskPanel();
	...
	public Canvas getViewPanel() {
		...
		stockTaskListgrid.addFetchDataHandler(new FetchDataHandler() {
			...
			public void onFilterData(FetchDataEvent event) {
				...
				criteria.addCriteria("taskType", "PK");
		...
		// 明细列表Grid
		final PickingTaskItemListgrid shelveTaskDetailManageListgrid = new PickingTaskItemListgrid();
		shelveTaskDetailManageListgrid.setHeight("100%");
		// 获取数据源
		String detailmodeName = "stockServiceBusiness.stockTask.pickingTask";
		String detaildsName = "pickingTaskItem_dataSource";
		...
		// 共用按钮面板
		PickingTaskButtonPanel shelveTaskButtonPanel = new PickingTaskButtonPanel(stockTaskListgrid, shelveTaskDetailManageListgrid);
		...
		// 主列表面板
		SectionStackSection headSection = new SectionStackSection("拣货任务信息");
		headSection.setItems(stockTaskListgrid);
		headSection.setExpanded(true);

		// 明细列表面板
		SectionStackSection detailSection = new SectionStackSection("拣货任务明细信息");
