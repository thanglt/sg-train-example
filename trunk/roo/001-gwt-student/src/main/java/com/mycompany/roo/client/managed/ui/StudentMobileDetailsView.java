...
public class StudentMobileDetailsView extends StudentMobileDetailsView_Roo_Gwt {
    ...
    private static com.mycompany.roo.client.managed.ui.StudentMobileDetailsView instance;
    ...
    public static com.mycompany.roo.client.managed.ui.StudentMobileDetailsView instance() {
        if (instance == null) {
