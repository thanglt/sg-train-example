...
@Service
@Transactional
public class PurposeVoucherPayManagerImpl extends CommonManagerImpl<PurposeVoucher>
		implements PurposeVoucherPayManager {

	private Logger log=LoggerFactory.getLogger(PurposeVoucherPayManagerImpl.class);
