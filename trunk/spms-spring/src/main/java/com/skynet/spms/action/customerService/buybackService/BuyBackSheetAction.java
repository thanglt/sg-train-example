 ...
 */
@Component
public class BuyBackSheetAction implements
		DataSourceAction<BuybackRequisitionSheet> {

	@Autowired
	private IBuybackSheetService buybackSheetService;
	@Autowired
	private ListGridFilterManager<BuybackRequisitionSheet> filterManager;

	@Override
	public String[] getBindDsName() {
		return new String[] { DSKey.C_BUYBACKSHEET_DS };
	}
	 ...
	 */
	@Override
	public void insert(BuybackRequisitionSheet item) {
		buybackSheetService.addSheet(item);
	}
	...
	public BuybackRequisitionSheet update(Map<String, Object> newValues,
			String itemID) {
		return buybackSheetService.update(newValues, itemID);
	}
	...
	public void delete(String itemID) {
		buybackSheetService.delete(itemID);
	}
	...
	public List<BuybackRequisitionSheet> doQuery(Map<String, Object> values,
		...
		if (criteria != null) {
			return filterManager.doQueryFilter(BuybackRequisitionSheet.class,
					criteria, startRow, endRow);
		}
		return buybackSheetService.doQuery(values, startRow, endRow);
	}
	...
	public List<BuybackRequisitionSheet> getList(int startRow, int endRow) {
		return buybackSheetService.getList(startRow, endRow);
	}
