...
public class ApplicationDataModifyWindow extends BaseWindow {

	public ApplicationDataModifyWindow(String windowTitle, boolean isMax,
	...
	protected Canvas getLeftLayout(final Rectangle srcRect, ListGrid listGrid) {
		...
		addCloseClickHandler(new CloseClickHandler() {
			public void onCloseClick(CloseClientEvent event) {
				ShowWindowTools.showCloseWindow(srcRect, ApplicationDataModifyWindow.this, -1);
			}
		});
		setWidth(470);
		setHeight(280);
		...
		//获取所选中的记录数据
		final Record record=applicationDataListGrid.getSelectedRecord();
		...
		tiRecommendedQuantity.setValue(record.getAttribute("recommendedQuantity"));
		itemList.add(tiRecommendedQuantity);
		 ...
		 rgiQuickEngineChangeIndicator.setValue(record.getAttribute("quickEngineChange"));
		 ...
		 sltETOPS.setValue(record.getAttribute("m_ETOPSFlightIndicator"));
		 ...
		 taiMiscellaneousText.setValue(record.getAttribute("miscellaneousText"));
		 ...
		 siEngineLevelOfMaintenanceCode.setValue(record.getAttribute("m_EngineLevelOfMaintenanceCode"));
		 ...
		 siMaintenanceOverhaulRepairCode.setValue(record.getAttribute("m_MaintenanceOverhaulRepairCode"));
		 ...
		 siExportControlClsCode.setValue(record.getAttribute("m_ExportControlClassificationCode"));
	    ...
	    cancelButton.setTitle(buttonConstants.cancelButton());
