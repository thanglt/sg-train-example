 ...
 */
@Component
public class PartsSelectDatasourceAction implements DataSourceAction<PartsInventoryRecord>{
	@Autowired
	private PartsInventoryRecordManager partsInventoryRecordManager;

	@Override
	public String[] getBindDsName() {
		return new String[]{"partsSelect_dataSource"};
	}
	...
	public List<PartsInventoryRecord> getList(int startRow, int endRow) {
		return partsInventoryRecordManager.getPartsInventoryRecord(null, startRow, endRow);
	}
}