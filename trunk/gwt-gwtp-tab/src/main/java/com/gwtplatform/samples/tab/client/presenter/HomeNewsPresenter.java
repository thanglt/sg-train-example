...
/**
 * A sample {@link com.gwtplatform.mvp.client.Presenter} filled with arbitrary content.
 * It appears as a tab within {@link HomePresenter}, which
 * is itself a s tab in {@link MainPagePresenter}.
 * <p />
 * It demonstrates the option 3 described in {@link com.gwtplatform.mvp.client.annotations.TabInfo}.
 *
