 ...
 * @Date 2011-7-12
 */
public interface ISalesContractTemplateManager {
	/**
	 * 
	 * 描述：添加一条记录
	 * 
	 ...
	 *            销售合同实体
	 */
	public void addSalesContractTemplate(SalesContractTemplate o);
	 ...
	 */
	public SalesContractTemplate getSalesContractTemplateById(String id);
