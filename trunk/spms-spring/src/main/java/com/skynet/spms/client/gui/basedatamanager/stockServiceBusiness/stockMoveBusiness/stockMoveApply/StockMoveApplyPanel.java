 ...
 *
 */
public class StockMoveApplyPanel extends ShowcasePanel{
	
    private static String moveId;
	
	private StockMoveApplyButtonPanel stockMoveOutRecordButtonPanel;
	...
	public static class Factory implements PanelFactory {
		...
		private String DESCRIPTION = "移库申请管理模块";
		private String id;

		public Canvas create() {
			StockMoveApplyPanel panel = new StockMoveApplyPanel();
	...
	public Canvas getViewPanel() {	
		...
		// 主列表Grid
		stockMoveOutRecordListgrid = new StockMoveApplyListgrid();
		stockMoveOutRecordListgrid.setHeight("50%");
		
		// 取得Grid中需要显示的数据源
		String mainmodeName = "stockServiceBusiness.partsInventory.stockMoveBusiness.stockMoveApply";
		String maindsName = "stockMovingApply_dataSource";
		...
		//明细Grid
		stockMoveOutRecordItemListgrid = new StockMoveApplyItemListgrid();
		...
		// 共用按钮面板
		stockMoveOutRecordButtonPanel = new StockMoveApplyButtonPanel(stockMoveOutRecordListgrid,stockMoveOutRecordItemListgrid);
		...
		// 主列表面板
		SectionStackSection headSection = new SectionStackSection("移库申请记录信息");
		headSection.setItems(stockMoveOutRecordListgrid);
		headSection.setExpanded(true);

		// 明细列表面板
		SectionStackSection detailSection = new SectionStackSection("移库申请记录明细信息");
