 ...
 * 
 */
public class DeliveryOrderViewWindow extends BaseWindow {

	/**
	 * 无需传递数据源 重载
	 * @param opm 当前操作方式
	 */
	public DeliveryOrderViewWindow(String windowTitle, boolean isMax,
	...
	protected Canvas getLeftLayout(Rectangle srcRect, ListGrid listGrid) {
		...
		/**面板1**/
		DeliveryViewTabSet tabSet = new DeliveryViewTabSet();
