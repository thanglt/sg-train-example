package com.skynet.spms.client.gui.customerplatform.customerdata.customerinfo;
...
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.AirworthinessPanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.BankInfoPanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.ConsigneeAddressPanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.CustomerCreditLinePanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.CustomerCreditPanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.EnterpriseGTAPanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.EnterpriseInfoButtonToolBar;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.EnterpriseInfoTreeGrid;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.RecipeInvoiceAddressPanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.ShippingAddressPanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.SupplierQAPanel;
import com.skynet.spms.client.gui.basedatamanager.organization.enterpriseInfo.VATPanel;
...
public class CustomerInfoPanel extends ShowcasePanel {
	...
	public CustomerInfoPanel(String moduleName, String dataSourceName) {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			CustomerInfoPanel panel = new CustomerInfoPanel(moduleName,dataSourceName);
			id = panel.getID();
			return panel;
		}
	...
	public Canvas getViewPanel() {
		...
		// 设置Feature
		String custModuleName = "customerplat.customerData.customerInfo";
		// 主Layout
		...
		enterpriseInfoTreeGrid.setComacUser(false);
		//按钮面板（增删改查等按钮）
		enterpriseInfoButtonToolBar = new EnterpriseInfoButtonToolBar(custModuleName,enterpriseInfoTreeGrid);
		...
		dataSourceTool.onCreateDataSource(moduleName, dataSourceName, new PostDataSourceInit() {
			...
			public void doPostOper(final DataSource dataSource, final DataInfo dataInfo) {
				...
				enterpriseInfoTreeGrid.fetchData(criteria,new DSCallback() {		
					@Override
					public void execute(DSResponse response, Object rawData, DSRequest request) {
						Record record = response.getData()[0];
						String customerId = record.getAttribute("id");
						enterpriseInfoTreeGrid.setEnterpriseId(customerId);
					}
				});
