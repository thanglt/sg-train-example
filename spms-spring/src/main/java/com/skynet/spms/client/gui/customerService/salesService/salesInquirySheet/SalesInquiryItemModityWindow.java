 ...
 * 
 */
public class SalesInquiryItemModityWindow extends Window {

	private LayoutDynamicForm form = new LayoutDynamicForm();

	
	public SalesInquiryItemModityWindow(final SalesInquiryItemListGrid itemListGrid,final SalesInquiryListGrid listGrid) {
	 ...
	 * 构建明细表单
	 */
	private void buildItemForm(SalesInquiryItemListGrid itemlistGrid) {
		form.setDataSource(itemlistGrid.getDataSource());
		form.reset();
		form.editSelectedData(itemlistGrid);
		...
		form.setFields(item1, item2, item3, item5, item6, item7,
