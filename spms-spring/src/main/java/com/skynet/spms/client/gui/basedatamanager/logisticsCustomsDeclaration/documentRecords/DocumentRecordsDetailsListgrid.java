...
public class DocumentRecordsDetailsListgrid extends ListGrid {

	private Logger log = Logger.getLogger("DocumentRecordsDetailsListgrid");

	public void drawDocumentRecordsDetailsListgrid()
	{
