...
public class RepairQuoteRecordForm extends VLayout {
	...
	public static ListGrid tempItemDetailGrid;
	...
	private void build() {
		...
		final IButton fillBtn = new IButton("带出数据");
		...
		SectionStackSection section = new SectionStackSection("修理报价明细项");
		...
		SectionStackSection sectionTemp = new SectionStackSection("供应商修理报价明细项");
