...
public class TitleImgUploader extends FileUploader{
	
	
	@Inject
	public TitleImgUploader(HttpServletRequest req, HttpServletResponse res) {
		super(req, res);
	}
...
//			IhasTitleImg hasTitleImg = (IhasTitleImg) bm;
//			hasTitleImg.setTitleImg(assets.get(0));
