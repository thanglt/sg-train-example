...
public class PickUpOrderListGrid extends FilterListGrid {
	...
	public void drawGrid() {
		...
		ListGridField field2 = new ListGridField("field2", "提货指令编号");
		...
		ListGridField field6 = new ListGridField("field6", "提货单位");

		ListGridField field7 = new ListGridField("field7", "收货单位");

		ListGridField field8 = new ListGridField("field8", "提货日期");
