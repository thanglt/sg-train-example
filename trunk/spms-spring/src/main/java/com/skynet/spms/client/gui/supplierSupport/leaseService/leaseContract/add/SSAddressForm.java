...
public class SSAddressForm extends VLayout {
	...
	final TextItem contractId = new TextItem();
		...
		dataSourceTool.onCreateDataSource(DSKey.S_LEASECONTRACT,
				DSKey.S_LEASEATTACHMENT_DS, new PostDataSourceInit() {
					public void doPostOper(DataSource dataSource,
						...
						shippingAddressAndPostCodeItem
								.setName("shippingZipCode");
						...
						consignorAddressAndPostCodeItem
								.setName("invocieZipCode");
						...
						form.setFields(contractId, shippingAdressItem,
								consigneeAdressItem, consignorItem,
								recipientItem, shippingAddressAndPostCodeItem,
								consignorAddressAndPostCodeItem,
								recipeInvoiceAdressItem, recipeItem,
								recipeInvoiceAddressAndPostCodeItem);
					}
				});
