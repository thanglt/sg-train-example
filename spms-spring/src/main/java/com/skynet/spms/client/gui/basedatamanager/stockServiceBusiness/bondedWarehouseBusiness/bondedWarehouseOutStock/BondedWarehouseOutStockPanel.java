 ...
 *
 */
public class BondedWarehouseOutStockPanel extends ShowcasePanel {

	private static final String DESCRIPTION = "保税库出库信息维护页面";

	private BondedWarehouseOutStockButtonPanel bondedWarehouseInStockButtonPanel;
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BondedWarehouseOutStockPanel panel = new BondedWarehouseOutStockPanel();
	...
	public Canvas getViewPanel() {
		...
		// 获取数据源
		String modeName = "stockServiceBusiness.bondedWarehouseBusiness.bondedWarehouseOutStock";
		String dsName = "bondedWarehouseOutStock_dataSource";
		...
		// 主列表Grid
		bondedWarehouseInStockListgrid = new BondedWarehouseOutStockListgrid();
		...
		// 共用按钮面板
		bondedWarehouseInStockButtonPanel = new BondedWarehouseOutStockButtonPanel(bondedWarehouseInStockListgrid);
