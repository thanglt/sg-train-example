...
public class LgbAssetUploadLayoutProvider implements Provider<AssetUploadLayout>{
	
	private ViewNameEnum sourceViewName = ViewNameEnum.LGB_EDIT;
	
	private UploadFor[] uploadFors= new UploadFor[]{UploadFor.LGB_ZP,UploadFor.ATTACHMENT};
	...
	public LgbAssetUploadLayoutProvider(){
		allowExts.put(UploadFor.LGB_ZP, new String[]{"jpg","gif","bmp","png","jpeg"});
