...
/**
 * A sample {@link com.gwtplatform.mvp.client.Presenter} that allows the user to trigger various types of
 * dialog boxes and popup windows. It appears as a tab within
 * {@link MainPagePresenter}.
 * <p />
 * It demonstrates the option 1 described in {@link com.gwtplatform.mvp.client.annotations.TabInfo}.
