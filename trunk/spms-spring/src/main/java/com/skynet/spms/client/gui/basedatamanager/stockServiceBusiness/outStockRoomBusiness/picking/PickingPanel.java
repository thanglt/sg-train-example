...
public class PickingPanel extends ShowcasePanel {

	private static final String DESCRIPTION = "拣货指令管理信息维护页面";

	public static class Factory implements PanelFactory {

		private String DESCRIPTION = "拣货指令管理模块";
		private String id;
		
		public Canvas create() {
			PickingPanel panel = new PickingPanel();
	...
	public Canvas getViewPanel() {
		...
		String headModeName = "stockServiceBusiness.outStockRoomBusiness.picking";
		String headDSName = "picking_dataSource";
		...
		String detailModeName = "stockServiceBusiness.outStockRoomBusiness.picking";
		...
		// 头部列表面板
		SectionStackSection headSection = new SectionStackSection("拣货指令信息");
		...
		SectionStackSection detailSection = new SectionStackSection("拣货指令明细信息");
		detailSection.setItems(detailVLayout);
		detailSection.setExpanded(true);

		// 共用按钮面板
		final PickingButtonPanel stockroomManageButtonPanel =
			new PickingButtonPanel(pickingListListgrid, pickingListPartItemsListgrid);
