...
public class myGwt implements EntryPoint {
    ...
    private final String wsdl = "/services/Version?wsdl";
    ...
    public void onModuleLoad() {
        ...
        //name input
        IButton btn = new IButton("get wsdl");

        final IButton btn2 = new IButton("get version");
        btn2.setDisabled(true);

        final IButton btn3 = new IButton("get version 2");
        ...
        btn2.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {
                ...
                service.callOperation("getVersion", data, "//String", new WebServiceCallback() {
        ...
        btn3.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {
                Map data = new LinkedHashMap();
                service.callOperation("getVersion", data, "getVersionResponse", new WebServiceCallback() {
                    public void execute(Object[] data, JavaScriptObject xmlDoc, RPCResponse rpcResponse, JavaScriptObject wsRequest) {
                        System.out.println(data.length);
                        String s = (String) data[0];
                        label.setContents(s);
