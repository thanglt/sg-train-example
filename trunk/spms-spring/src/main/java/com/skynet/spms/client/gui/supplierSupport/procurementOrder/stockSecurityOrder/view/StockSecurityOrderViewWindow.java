package com.skynet.spms.client.gui.supplierSupport.procurementOrder.stockSecurityOrder.view;
 ...
 *
 */
public class StockSecurityOrderViewWindow extends BaseWindow {

	/**
	 * 无需传递数据源 重载
	 * @param opm 当前操作方式
	 */
	public StockSecurityOrderViewWindow(String windowTitle, boolean isMax,
