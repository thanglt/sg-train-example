package com.skynet.spms.manager.customerService.GuaranteeClaimService.GuaranteeClaimRequisitionSheetItem;
 ...
 * @Date 2011-7-12
 */
public interface GuaranteeClaimRequisitionSheetItemManager {
	/**
	 * 
	 * 描述：添加一条记录
	 * 
