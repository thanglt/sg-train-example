 ...
 *
 */
public class StockMoveOutRecordPanel extends ShowcasePanel{
	
    private static String moveId;
	
	private StockMoveOutRecordButtonPanel stockMoveOutRecordButtonPanel;
	...
	public static class Factory implements PanelFactory {
		...
		private String DESCRIPTION = "移出库管理模块";
		private String id;

		public Canvas create() {
			StockMoveOutRecordPanel panel = new StockMoveOutRecordPanel();
	...
	public Canvas getViewPanel() {	
		...
		// 主列表Grid
		stockMoveOutRecordListgrid = new StockMoveOutRecordListgrid();
		stockMoveOutRecordListgrid.setHeight("50%");
		// 取得Grid中需要显示的数据源
		String mainmodeName = "stockServiceBusiness.partsInventory.stockMoveBusiness.stockMoveOutRecord";
		String maindsName = "stockMovingOutRecord_dataSource";
		...
		//明细Grid
		stockMoveOutRecordItemListgrid = new StockMoveOutRecordItemListgrid();
		...
		// 共用按钮面板
		stockMoveOutRecordButtonPanel = new StockMoveOutRecordButtonPanel(stockMoveOutRecordListgrid,stockMoveOutRecordItemListgrid);
		...
		// 主列表面板
		SectionStackSection headSection = new SectionStackSection("航材移出记录信息");
		headSection.setItems(stockMoveOutRecordListgrid);
		headSection.setExpanded(true);

		// 明细列表面板
		SectionStackSection detailSection = new SectionStackSection("航材移出记录明细信息");
