 ...
 */
@Component
public class StockMovingApplyDatasourceAction implements DataSourceAction<StockMovingRecord>{
	@Autowired
	private StockMovingRecordManager stockMovingRecordManager;

	@Override
	public String[] getBindDsName() {
		return new String[]{"stockMovingApply_dataSource"};
	}
...
//	}
	...
	public List<StockMovingRecord> getList(int startRow, int endRow) {
		return stockMovingRecordManager.GetAllbyApply();
	}
}