...
@Singleton
public class XinJianCatLayout extends MyTreeGridLayout implements Iview,ICanShare,ICanConfirmSome{
	...
	protected void initTreeGrid() {
        ...
        treeGrid.setFields(nameField,auiService.getIdField(false),auiService.getCreatedAtField(false),parentField,auiService.getVersionField(),auiService.getPositionField());
	}
