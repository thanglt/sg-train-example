...
public class XinJianCatChecker extends TreeChecker<XinJianCat> {
	...
	protected boolean canCustom() {
		...
		case MANAGE_RELATION:
			XinJianCat xjc = getModel();
			if(isSiteEditor(xjc.getSiteId()) || isSiteOwner(xjc.getSiteId()))return true;
