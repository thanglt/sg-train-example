...
//	String leaseId = modelLocator.leaseInstructListGrid.getSelectedRecord()
		...
		dataSourceTool.onCreateDataSource(DSKey.C_LEASECONTRACT_ITEM,
				DSKey.C_LEASECONTRACT_TIEM_DS, new PostDataSourceInit() {
					public void doPostOper(DataSource dataSource,
						...
						criteria.addCriteria("contractNumber", modelLocator.leaseInstructListGrid.getSelectedRecord()
							.getAttribute("contractNumber"));
