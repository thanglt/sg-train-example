...
import com.skynet.spms.client.service.PrintContainerServiceAsync;
...
public class SetPrintContainerWindow extends Window {

	private PrintContainerServiceAsync printContainerService = GWT.create(PrintContainerService.class);
	 ...
	 * @param iconUrl
	 */
	public SetPrintContainerWindow(String windowTitle, boolean isMax,
		...
		mainForm.setFields(printDevice);
		...
		btnSave.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				String[] containerIDs = new String[selRecordCount];
				for (int i = 0; i < selRecordCount; i++) {
					containerIDs[i] = listGrid.getSelection()[i].getAttribute("id");
				}
				...
				printContainerService.print(containerIDs, port,
