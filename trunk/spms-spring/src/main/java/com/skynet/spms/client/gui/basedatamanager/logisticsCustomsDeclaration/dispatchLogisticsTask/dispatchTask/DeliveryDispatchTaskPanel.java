...
public class DeliveryDispatchTaskPanel extends ShowcasePanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			DeliveryDispatchTaskPanel panel = new DeliveryDispatchTaskPanel();
	...
	public Canvas getViewPanel() {
		...
		deliveryOrderListgrid.setHeight("65%");
		DataSourceTool headDST = new DataSourceTool();
		String headModeName = "logisticsCustomsDeclaration.dispatchLogisticsTask.deliveryDispatchTask";
				...
				if (fieldName.equals("assignWork")) {
					...
					linkItem.addClickHandler(new com.smartgwt.client.widgets.form.fields.events.ClickHandler() {
						...
						public void onClick(com.smartgwt.client.widgets.form.fields.events.ClickEvent event) {
							...
							String customsDeclarationType = deliveryOrderListgrid.getSelectedRecord().getAttributeAsString("customsDeclarationType");
								...
								headDST.onCreateDataSource(headModeName, headDSName,
										new PostDataSourceInit() {
											public void doPostOper(DataSource dataSource,
												...
												Criteria criteria = new Criteria();
												criteria.addCriteria("orderID", deliveryOrderListgrid.getSelectedRecord().getAttribute("id"));
		...
		String detailModeName = "logisticsCustomsDeclaration.dispatchLogisticsTask.deliveryDispatchTask";
		...
		deliveryOrderListgrid.addRecordClickHandler(new RecordClickHandler() {
			public void onRecordClick(RecordClickEvent event) {
				...
				pickupDeliveryTaskAssignListgrid.fetchData(new Criteria("orderID", "" + deliveryOrderListgrid.getSelectedRecord().getAttribute("id").toString()));
			}
		});
		...
		// 头部列表面板
		SectionStackSection headSection = new SectionStackSection("发货任务分派信息");
		...
		SectionStackSection detailSection = new SectionStackSection("发货任务分派明细信息");
		detailSection.setItems(detailVLayout);
		detailSection.setExpanded(true);

		// 共用按钮面板
		final DeliveryDispatchTaskButtonPanel dispatchTaskButtonPanel =
			new DeliveryDispatchTaskButtonPanel(deliveryOrderListgrid, pickupDeliveryTaskAssignListgrid);
