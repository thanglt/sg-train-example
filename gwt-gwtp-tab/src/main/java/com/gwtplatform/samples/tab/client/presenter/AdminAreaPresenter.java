...
/**
 * A sample {@link com.gwtplatform.mvp.client.Presenter} that should only be displayed to administrator users.
 * It appears as a tab within {@link MainPagePresenter}.
 * <p />
 * It uses {@link com.gwtplatform.samples.tab.client.IsAdminGatekeeper} to prevent access to non-administrator users.
 * <p />
 * It uses the option 3 described in {@link com.gwtplatform.mvp.client.annotations.TabInfo} to describe the tab using a
 * {@link com.gwtplatform.samples.tab.client.TabDataExt} that ensures the tab is not visible to non-administrator users.
 *
