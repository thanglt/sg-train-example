...
import com.skynet.spms.client.gui.basedatamanager.logisticsCustomsDeclaration.customsDeclaration.importCustomsDeclaration.importCustomsDeclaration.ImportCustomsDeclarationItemsListgrid;
 ...
 *
 */
public class ImportCustomsTariffRecordDetailWindow extends Window {
	 ...
	 * @param b 
	 */
	public ImportCustomsTariffRecordDetailWindow(String windowTitle,
			boolean isMax,
		...
		// 进口报关关税ID
		final HiddenItem txtImportCustomsTariffID = new HiddenItem("id");
		// 报关ID
		...
		final ImportCustomsDeclarationItemsListgrid importCustomsDeclarationItemsListgrid = 
			new ImportCustomsDeclarationItemsListgrid();
		importCustomsDeclarationItemsListgrid.setWidth(610);
		importCustomsDeclarationItemsListgrid.setHeight(210);
		...
		headForm.setFields(txtImportCustomsTariffID
				,txtCustomsID
				,txtOrderID
				,contractNumber
				,prepareEnterNumber
		...
		secondForm.setFields(txtImportCustomsTariffID
				,txtCustomsID
				,txtOrderID
				,applicant
				,tariffOrder
