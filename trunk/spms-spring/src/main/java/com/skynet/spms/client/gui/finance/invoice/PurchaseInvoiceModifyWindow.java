...
public class PurchaseInvoiceModifyWindow extends BaseWindow {
...
private static final String FONT_COLOR_RED_FONT = "<font color=red>*</font>";
	...
	public PurchaseInvoiceModifyWindow(String windowTitle, boolean isMax,
	...
	protected Canvas getLeftLayout(final Rectangle srcRect, ListGrid listGrid) {
		...
		Record rdd = listGrid.getSelectedRecord();
		...
		txtInvoiceNumber.setValue(rdd.getAttribute("invoiceNumber"));
		...
		selBusinessType.setValue(rdd.getAttribute("m_InvoiceBusinessType"));
		...
		selContract.setValue(rdd.getAttribute("contractNumber"));
	...
	selContract.addTitleDoubleClickHandler(new TitleDoubleClickHandler() {
		...
		selInvoiceType.setValue(rdd.getAttribute("m_InvoiceType"));
		...
		selCurrencyCode.setValue(rdd.getAttribute("m_InternationalCurrencyCode"));
		itemList.add(selCurrencyCode);

		final TextItem txtTaxRate = new TextItem("taxRate");
		txtTaxRate.setEndRow(true);
		txtTaxRate.setValue(rdd.getAttribute("taxRate"));
		...
		txtAmount.setValue(rdd.getAttribute("amount"));
		...
		txtTax.setValue(rdd.getAttribute("tax"));
		...
		txtTotalAmount.setValue(rdd.getAttribute("totalAmount"));
		...
		invoiceUser.setValue(rdd.getAttribute("invoiceUser"));
		...
		HiddenItem check = new HiddenItem("isChecked");
		check.setValue(rdd.getAttribute("isChecked"));
		itemList.add(check);
