...
privileged aspect AccountController_Roo_Controller {
    ...
    public String AccountController.update(@RequestBody String orderInString,@Valid Account account, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("account", account);
