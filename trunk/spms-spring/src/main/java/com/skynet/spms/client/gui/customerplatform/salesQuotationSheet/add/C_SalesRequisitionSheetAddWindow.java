...
//		quotationBus.refeshListGrid();
	...
	private ListGrid getLeftGrid() {
		...
		ListGridField field2 = new ListGridField(
				"salesQuotationSheet.quotationSheetNumber"/* , "报价编号" */);
		...
		ListGridField field4 = new ListGridField("quantity"/* , "报价数量" */);
		Utils.formatQuantityField(field4);

		ListGridField field5 = new ListGridField("unitPriceAmount"/* , "报价单价" */);
		Utils.formatPriceField(field5);

		ListGridField field6 = new ListGridField("deliveryLeadTime"/* , "交货期" */);
