 ...
 */
@Component
public class GuaranteeAttachmentDatasourceAction implements
		DataSourceAction<Attachment> {

	@Autowired
	private IGuaranteeAttachmentManager manager;

	/**
	 * 描述： 担保索赔附件数据源
	 */
	public String[] getBindDsName() {
		return new String[] { DSKey.C_GUARANTEE_ATTACHMENT_DS };
	}
