...
import com.skynet.spms.client.gui.supplierSupport.procurementOrder.deliveryOrder.add.DeliveryOrderAddWindow;
import com.skynet.spms.client.gui.supplierSupport.procurementOrder.deliveryOrder.modity.DeliveryOrderModityWindow;
...
public class DeliveryOrderToolStrip extends BaseButtonToolStript {
	...
	//
	// private ToolStripMenuButton statusMBtn;
	//
	...
	public DeliveryOrderToolStrip(DeliveryOrderListGrid listGrid) {
	...
	protected void showWindow(String buttonName, ToolStripButton button) {
		if ("ADD".equals(buttonName)) {
			DeliveryOrderAddWindow ppa = new DeliveryOrderAddWindow("新建发货指令",
					true, button.getPageRect(), null, "");
			ShowWindowTools.showWindow(button.getPageRect(), ppa, 200);
		} else if ("MODIFY".equals(buttonName)) {
			DeliveryOrderModityWindow ppa = new DeliveryOrderModityWindow(
					"修改发货指令", true, button.getPageRect(), null, "");
			ShowWindowTools.showWindow(button.getPageRect(), ppa, 200);
