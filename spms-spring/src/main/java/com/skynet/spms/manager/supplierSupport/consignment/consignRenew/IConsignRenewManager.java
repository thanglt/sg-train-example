package com.skynet.spms.manager.supplierSupport.consignment.consignRenew;
 ...
 * @Date 2011-7-12
 */
public interface IConsignRenewManager {
	/**
	 * 
	 * 描述：添加一条记录
	 * 
	 ...
	 *           寄售申请单实体
	 */
	public void addSheet(ConsignRenew pact);
	 ...
	 * @return 返回修改后的实体
	 */
	public ConsignRenew update(Map<String, Object> newValues,
			String itemID);
	 ...
	 * @return 返回查询结果集合
	 */
	public List<ConsignRenew> doQuery(
