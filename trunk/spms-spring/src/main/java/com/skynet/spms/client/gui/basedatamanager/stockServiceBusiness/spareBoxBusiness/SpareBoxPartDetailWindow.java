...
public class SpareBoxPartDetailWindow extends Window {
	 ...
	 * @param pickingListID
	 */
	public SpareBoxPartDetailWindow(String windowTitle
		...
		// 项号
		final TextItem txtItemNumber = new TextItem("itemNumber", "项号");
		txtItemNumber.setDisabled(true);
		// 件号
		...
		// 备注
		final TextItem txtMemo = new TextItem("memo", "备注");
		txtMemo.setDisabled(true);
		...
		partsInventoryRecordListGrid.setHeight(160);
...
//						sendQtyFiled.setCellFormatter(new CellFormatter() {
...
//		partsInventoryRecordListGrid.addEditorExitHandler(new EditorExitHandler() {
//			@Override
//			public void onEditorExit(EditorExitEvent event) {
//				String curSendQty = "";
//				if (event.getNewValue() != null)
//				{
//					curSendQty = event.getNewValue().toString();
//				}
//				partsInventoryRecordListGrid.getSelectedRecord().setAttribute("pickingListPartItems.sendQty", curSendQty);
//			}
//		});
		...
		btnSave.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				// 项号
				String[] itemNumbers = new String[rowCount];
				// 件号
				...
				for (int i = 0; i < partsInventoryRecordListGrid.getTotalRows(); i++)
				{
					...
					// 项号
					itemNumbers[i] = String.valueOf(i);
					// 件号
				...
				// 项号
				record.setAttribute("itemNumber", itemNumbers);
				// 件号
		...
		mainForm.setFields(txtItemNumber
						,txtPartNumber
						,txtManufacturer
						,txtUnit
						,txtPartStatus
		...
		final HLayout layoutHeadBtn = new HLayout(); 
		layoutHeadBtn.setMargin(5);
		layoutHeadBtn.setMembersMargin(5);
